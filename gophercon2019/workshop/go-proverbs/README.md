...
This is a sample template for go-proverbs - Below is a brief explanation of what we have generated for you:

```bash
.
├── Makefile                    <-- Make to automate build
├── README.md                   <-- This instructions file
├── go-proverbs                 <-- Source code for a lambda function
...
aws cloudformation describe-stacks \
    --stack-name go-proverbs --query 'Stacks[].Outputs'
```

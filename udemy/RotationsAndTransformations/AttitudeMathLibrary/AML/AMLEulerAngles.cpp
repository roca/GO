...
namespace AML
{
    ...
    Matrix33 eulerAngles2DCM_XYX(double phi, double theta, double psi){return (DCM::rotationX(phi) * DCM::rotationY(theta) * DCM::rotationX(psi));}
    Matrix33 eulerAngles2DCM_YZY(double phi, double theta, double psi){return (DCM::rotationY(phi) * DCM::rotationZ(theta) * DCM::rotationY(psi));}
    Matrix33 eulerAngles2DCM_ZYZ(double phi, double theta, double psi){return (DCM::rotationZ(phi) * DCM::rotationY(theta) * DCM::rotationZ(psi));}
    Matrix33 eulerAngles2DCM_XZX(double phi, double theta, double psi){return (DCM::rotationX(phi) * DCM::rotationZ(theta) * DCM::rotationX(psi));}
    Matrix33 eulerAngles2DCM_YXY(double phi, double theta, double psi){return (DCM::rotationY(phi) * DCM::rotationX(theta) * DCM::rotationY(psi));}
    Matrix33 eulerAngles2DCM_YZX(double phi, double theta, double psi){return (DCM::rotationY(phi) * DCM::rotationZ(theta) * DCM::rotationX(psi));}
    Matrix33 eulerAngles2DCM_ZXY(double phi, double theta, double psi){return (DCM::rotationZ(phi) * DCM::rotationX(theta) * DCM::rotationY(psi));}
    Matrix33 eulerAngles2DCM_XZY(double phi, double theta, double psi){return (DCM::rotationX(phi) * DCM::rotationZ(theta) * DCM::rotationY(psi));}
    Matrix33 eulerAngles2DCM_ZYX(double phi, double theta, double psi){return (DCM::rotationZ(phi) * DCM::rotationY(theta) * DCM::rotationX(psi));}
    Matrix33 eulerAngles2DCM_YXZ(double phi, double theta, double psi){return (DCM::rotationY(phi) * DCM::rotationX(theta) * DCM::rotationZ(psi));}
